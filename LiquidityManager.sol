/**
 *Submitted for verification at testnet.bscscan.com on 2024-01-20
*/
...
contract LiquidityManagerXMST is IERC20, Ownable {
  ...
  function BuyRlxt () payable public returns (uint256 id) {
    ...
    require(IERC20(token).balanceOf(address(this)) >= token_amt, "Unable to buy XMX.");
